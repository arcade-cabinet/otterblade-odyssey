...
describe('HUD Component', () => {
    ...
    it('renders health hearts correctly', () => {
        ...
        const hearts = Array.from(container.querySelectorAll('span'))
            .filter(s => s.textContent.includes('❤️'));
        ...
        // Filled color: #E74C3C
        // Empty color: #555
        const filledHearts = hearts.filter(s => s.style.color === 'rgb(231, 76, 60)' || s.style.color === '#E74C3C'); // rgb(231, 76, 60) is #E74C3C
        const emptyHearts = hearts.filter(s => s.style.color === 'rgb(85, 85, 85)' || s.style.color === '#555');
