...
const SPRITE_MANIFEST: SpriteData[] = [
  ...
  { id: "finn_wall_climb", name: "Finn - Wall Climb", animation: "wall_climb", frames: 4, status: "needed" },
];
        ...
        {SPRITE_MANIFEST.map((sprite) => (
          ...
          >
            ...
            <div className="sprite-preview">
              {sprite.file ? (
                <img src={sprite.file} alt={sprite.name} style={{ maxWidth: "100%", imageRendering: "pixelated" }} />
              ) : (
