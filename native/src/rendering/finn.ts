...
export function createFinnMesh(scene: Scene): TransformNode {
  ...
  const armLeft = MeshBuilder.CreateCylinder(
    'finn-arm-left',
    {
      height: 0.25,
      diameter: 0.08,
  ...
  const armRight = MeshBuilder.CreateCylinder(
    'finn-arm-right',
    {
      height: 0.25,
      diameter: 0.08,
  ...
  const legLeft = MeshBuilder.CreateCylinder(
    'finn-leg-left',
    {
      height: 0.2,
      diameter: 0.1,
  ...
  const legRight = MeshBuilder.CreateCylinder(
    'finn-leg-right',
    {
      height: 0.2,
      diameter: 0.1,
