 ...
 */
export const EnemiesManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const SpritesManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const CinematicsManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const SoundsManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const EffectsManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const ItemsManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const ScenesManifestSchema = z
  .object({
    $schema: z.string().optional(),
 ...
 */
export const ChapterPlatesManifestSchema = z
  .object({
    $schema: z.string().optional(),
