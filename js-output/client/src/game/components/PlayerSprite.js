 ...
 */
export function PlayerSprite({ position }) {
    ...
    return (React.createElement("mesh", { ref: meshRef, position: position, scale: [facingRight ? 1 : -1, 1, 1] },
        React.createElement("planeGeometry", { args: [spriteWidth, spriteHeight] }),
        React.createElement("meshBasicMaterial", { map: texture, transparent: true, alphaTest: 0.1, side: THREE.DoubleSide })));
}
