...
export function Player() {
    ...
    const spritePosition = useRef([checkpointX, checkpointY, 0.5]);
    ...
    useFrame((_, delta) => {
        if (!rigidBodyRef.current || gameOver)
            return;
    ...
    return React.createElement(PlayerSprite, { position: spritePosition.current });
}
