...
const activeSounds = new Map(); // sound id -> howl play id
 ...
 */
export const BIOME_AUDIO_PROFILES = {
 ...
 */
export function registerSound(id, config) {
    if (sounds.has(id)) {
 ...
 */
export function stopSound(id, fadeOut) {
    const sound = sounds.get(id);
 ...
 */
export function stopCategory(category, fadeOut) {
 ...
 */
export function playMusic(id, crossfadeDuration = 2000) {
    if (currentMusic === id)
        return;
 ...
 * Stop all music
 */
export function stopMusic(fadeOut = 2000) {
    if (currentMusic) {
...
// ============================================================================
const activeAmbient = new Set();
/**
 * Set the ambient soundscape for a biome
 */
export function setAmbientForBiome(biomeIndex, crossfadeDuration = 3000) {
 ...
 */
export function createSilence(duration) {
