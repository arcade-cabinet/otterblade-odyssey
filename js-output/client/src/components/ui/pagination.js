...
const Pagination = ({ className, ...props }) => (React.createElement("nav", { "aria-label": "pagination", className: cn('mx-auto flex w-full justify-center', className), ...props }));
...
const PaginationPrevious = ({ className, ...props }) => (React.createElement(PaginationLink, { "aria-label": "Go to previous page", size: "default", className: cn('gap-1 pl-2.5', className), ...props },
    React.createElement(ChevronLeft, { className: "h-4 w-4" }),
    React.createElement("span", null, "Previous")));
PaginationPrevious.displayName = 'PaginationPrevious';
const PaginationNext = ({ className, ...props }) => (React.createElement(PaginationLink, { "aria-label": "Go to next page", size: "default", className: cn('gap-1 pr-2.5', className), ...props },
