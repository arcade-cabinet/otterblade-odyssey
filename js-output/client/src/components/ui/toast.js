...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (React.createElement(ToastPrimitives.Viewport, { ref: ref, className: cn('fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]', className), ...props })));
...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => (React.createElement(ToastPrimitives.Title, { ref: ref, className: cn('text-sm font-semibold', className), ...props })));
ToastTitle.displayName = ToastPrimitives.Title.displayName;
const ToastDescription = React.forwardRef(({ className, ...props }, ref) => (React.createElement(ToastPrimitives.Description, { ref: ref, className: cn('text-sm opacity-90', className), ...props })));
