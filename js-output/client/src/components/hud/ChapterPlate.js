...
function getChapterPlateData(chapterId) {
...
export default function ChapterPlate() {
    ...
    if (!showPlate || !currentPlate)
        return null;
    return (React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center pointer-events-none", style: {
            animation: 'fadeInOut 4s ease-in-out forwards',
        }, "data-testid": "chapter-plate" },
        React.createElement("div", { className: "relative max-w-4xl w-full mx-8" },
            React.createElement("div", { className: "relative rounded-lg overflow-hidden shadow-2xl", style: {
                    boxShadow: '0 0 60px rgba(0,0,0,0.8), inset 0 0 100px rgba(0,0,0,0.3)',
                } },
                React.createElement("img", { src: currentPlate.image, alt: currentPlate.title, className: "w-full h-auto", style: {
                        filter: 'sepia(0.1) saturate(1.05)',
                    } }),
                React.createElement("div", { className: "absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/95 via-black/70 to-transparent" },
                    React.createElement("p", { className: "text-sm text-amber-400/80 uppercase tracking-[0.3em] mb-2", style: {
                            textShadow: '0 1px 4px rgba(0,0,0,0.9)',
                        } }, currentPlate.setting),
                    React.createElement("h2", { className: "text-4xl md:text-5xl font-serif text-amber-100 mb-3", style: {
                            textShadow: '0 3px 12px rgba(0,0,0,0.9), 0 1px 2px rgba(0,0,0,1)',
                            fontFamily: 'Georgia, "Times New Roman", serif',
                        } }, currentPlate.title),
                    React.createElement("p", { className: "text-lg md:text-xl text-amber-200/90 italic", style: {
                        ...
                        "\"")),
                React.createElement("div", { className: "absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 border-amber-600/40" }),
                React.createElement("div", { className: "absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 border-amber-600/40" }),
                React.createElement("div", { className: "absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 border-amber-600/40" }),
                React.createElement("div", { className: "absolute bottom-4 right-4 w-8 h-8 border-r-2 border-b-2 border-amber-600/40" }))),
