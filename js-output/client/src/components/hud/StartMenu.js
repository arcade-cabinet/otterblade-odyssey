...
export default function StartMenu() {
    ...
    return (React.createElement(Box, { "data-testid": "start-menu", sx: {
            position: 'absolute',
            inset: 0,
            display: 'flex',
        ...
        React.createElement(Fade, { in: showContent, timeout: 1000 },
            React.createElement(Container, { maxWidth: "sm", sx: {
                ...
                React.createElement(Typography, { variant: "h1", component: "h1", sx: {
              ...
              `,
                ...
                React.createElement(Typography, { variant: "body1", sx: {
                        ...
                        px: 2,
                    } }, "A woodland-epic adventure awaits. Play as Finn, a brave otter warrior wielding the legendary Otterblade, defending Willowmere Hearthhold against the storm hawk Zephyros."),
                React.createElement(Button, { variant: "outlined", size: "large", onClick: handleStartGame, "data-testid": "button-start-game", sx: {
                        px: { xs: 4, sm: 6 },
                        py: 1.5,
                ...
                bestScore > 0 && (React.createElement(Fade, { in: true, timeout: 500 },
                    React.createElement(Paper, { elevation: 0, sx: {
                        ...
                        React.createElement(Box, { sx: {
                            ...
                            React.createElement(Typography, { variant: "body2", sx: { color: brandColors.stoneBeige.main } }, "Best Score"),
                        ...
                        React.createElement(Box, { sx: { display: 'flex', justifyContent: 'space-between' } },
                            React.createElement(Typography, { variant: "body2", sx: { color: brandColors.stoneBeige.main } }, "Furthest Distance"),
                            React.createElement(Typography, { variant: "body2", sx: {
                                    color: brandColors.honeyGold.main,
                                    fontWeight: 600,
                                } },
